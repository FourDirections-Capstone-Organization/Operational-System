...
public class TeamService : ITeamService
{
    ...
    public async Task<ApiResponseDTO<bool>> DeactivateAsync(Guid id, Guid userId)
    {
        ...
        try
        {
            await _auditLogService.LogAsync(userId, AuditActionType.Update, "Team", team.Id, null,
                $"Team '{team.Name}' deactivated", "TaskManagement");
        }
        catch { }

        return ApiResponseDTO<bool>.Success(true, "Team deactivated");
    }
