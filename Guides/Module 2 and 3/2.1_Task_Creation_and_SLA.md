...
├── CreateTaskDTO → input for creating a task
...
├── GetAllTasksAsync(filters) → return tasks with optional filters
├── GetTaskByIdAsync(id) → return one task with assignments and attachments
...
├── GET /api/tasks → get all tasks (with filters for status, priority, classification, etc.)
...
public interface ITaskService
{
    ...
    Task<ApiResponseDTO<List<TaskResponseDTO>>> GetAllAsync(
        ...
        string? search = null);
    Task<ApiResponseDTO<TaskResponseDTO>> GetByIdAsync(Guid id);
...
public class TaskService : ITaskService
{
    ...
    public async Task<ApiResponseDTO<TaskResponseDTO>> GetByIdAsync(Guid id)
    {
