...
```mermaid
graph TB
    START["🚀 Start Stack<br/><code>docker compose up --build -d</code>"]
    REG["🔌 Register Connector<br/><code>& '.\register-<br/>debezium-connector.ps1'</code>"]
    SYNC["🔄 Sync to Neo4j<br/><code>docker compose restart<br/>cdc-processor</code>"]
...
```mermaid
graph LR
    FE["🌐 Frontend<br/><b>http://localhost</b>"]
    API["⚙️ Backend API<br/><b>http://localhost:5100</b>"]
    SW["📘 Swagger Docs<br/><b>http://localhost:5100/swagger</b>"]
    PG["🐘 pgAdmin<br/><b>http://localhost:5050</b>"]
    NEO["🔷 Neo4j Browser<br/><b>http://localhost:7474</b>"]
    KUI["📊 Kafka UI<br/><b>http://localhost:8081</b>"]
    DAPI["🔗 Debezium API<br/><b>http://localhost:8083</b>"]
```
